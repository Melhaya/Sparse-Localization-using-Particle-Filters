...
void ParticleFilter::dataAssociation(vector<LandmarkObs> predicted, 
  ...
  for (int i = 0; i < observations.size(); i++) {
    ...
    double smallest_dist = sensor_range * sqrt(2);
...
void ParticleFilter::updateWeights(double sensor_range, double std_landmark[], 
  ...
  double weight_normalizer = 0.0; //To normalize weights to be between [0 1]
  ...
  for (int i = 0; i < num_particles; i++) {
    ...
    **************************************************************************************/
    ...
    /**************************************************************************************
     Step 2: Filter map landmarks to keep only those which are in the sensor_range of current particle.
    **************************************************************************************/    
